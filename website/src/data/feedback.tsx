...
const TWEETS: TweetItem[] = [
  {
    ...
    content: (
      <>
        Between release-plz and trusted publishing and cargo-semver-checks we are getting to a very
        cool place. My dream is that you get it all setup for free with "cargo new".
      </>
    ),
    showOnHomepage: true,
  ...
  },
  {
    ...
    date: "Jul 29, 2024",
    content: <>Release-plz makes releasing tokio-console super easy.</>,
    showOnHomepage: true,
    githubUsername: "hds",
  },
  {
    ...
    name: "Luca Palmieri",
    date: "Apr 21, 2024",
    content: <>God bless @MarcoIeni for release-plz.</>,
    showOnHomepage: true,
  ...
  },
  {
    ...
    content: (
      <>
        Release-plz will automatically run cargo-semver-checks as part of the release process. If
        you are in the market for a good release manager, you should check this one out; it's
        awesome.
      </>
    ),
    showOnHomepage: true,
  ...
  },
  {
    ...
    content: (
      <>
        As far as I can tell, release-plz (an actual Rust executable running in CI, comes with its
        own GitHub Action) is best-of-class.
      </>
    ),
    showOnHomepage: true,
  ...
  },
  {
    ...
    content: (
      <>
        This is a great project to contribute to, it's so incredibly valuable for other maintainers
        like myself to be able to automate project releases and provide a better experience for our
        contributors.
      </>
    ),
    showOnHomepage: true,
